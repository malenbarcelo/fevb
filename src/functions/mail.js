...
async function sendMail(td,mailData) {
    ...
    try {
        ...
        mailData.selection.forEach(s => {
            htmlSelection += '<br>' + s.type + ': ' + s.categories            
        });
        ...
        const mailOptions = {
            ...
            html: `
                ...
                <p style="color:red;"><b>Para reservar tu cupo, por favor transferí $ ${mailData.price} al alias "FIDEO.PLANO.BARRO"<br>y enviá el comprobante a comprobantes@elvientoblanco.org.ar<br>dentro de las próximas 24 hs.</b></p>
                <p style="color:black;"><b>RESUMEN DE LA INSCRIPCIÓN:</b>${htmlSelection}</p>
                <p style="color:black;"><b>HORARIO:</b><br>${mailData.schedule}</p>
                <p style="color:black;"><b>DOMICILIO:</b><br>Gral. Manuel Belgrano 1408, Q8300 Neuquén</p>
